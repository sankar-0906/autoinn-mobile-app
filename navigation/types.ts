export type RootStackParamList = {
    ...
    SelectModel: { returnTo?: 'QuotationForm' | 'AddQuotation' | 'FollowUpQuotationForm'; quotationId?: string; viewMode?: boolean; viewVehicleData?: any; paymentDetails?: any } | undefined;
    SelectPrice: { vehicleId: string; vehicleData?: any; returnTo?: 'QuotationForm' | 'AddQuotation' | 'FollowUpQuotationForm'; quotationId?: string; viewMode?: boolean; paymentDetails?: any };
    SelectPayment: { vehicleId: string; vehicleData?: any; priceDetails: any; returnTo?: 'QuotationForm' | 'AddQuotation' | 'FollowUpQuotationForm'; quotationId?: string; viewMode?: boolean; paymentDetails?: any };
