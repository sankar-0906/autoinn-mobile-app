...
export const PendingSection: React.FC<SectionProps> = ({ data, onItemPress, onEdit, onDelete, loading, onRefresh, renderPaginationFooter }) => (
    <FlatList
        data={data}
        renderItem={({ item }) => (
        ...
        ListEmptyComponent={
            <View className="flex-1 items-center justify-center p-10">
                <Text className="text-gray-500 text-center text-lg">No pending job cards found.</Text>
            </View>
        }
